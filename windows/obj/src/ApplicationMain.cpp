...
HXLINE(  41)		app->meta->set(HX_("name",4b,72,ff,48),HX_("MyApp",75,30,07,a6));
HXLINE(  42)		app->meta->set(HX_("packageName",f1,04,ad,04),HX_("com.example.HelloWorld",d1,9f,22,70));
...
HXLINE(  49)		 ::Dynamic attributes =  ::Dynamic(::hx::Anon_obj::Create(16)
            			...
            			->setFixed(9,HX_("title",98,15,3b,10),HX_("MyApp",75,30,07,a6))
